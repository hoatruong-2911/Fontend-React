...
const ProductListPage = () => {
    ...
    const [productsPerPage] = useState(5); // Đã sửa lại là 7 sản phẩm/trang
    ...
    if (loading) {
        return <div className="text-center text-xl font-semibold">Đang tải dữ liệu...</div>;
    }
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex items-center space-x-4 mb-6 p-4 border rounded-lg bg-gray-50">
                ...
                <button onClick={handleReset} className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">
                    Reset
                </button>
            </div>
                            ...
                            <tr key={product.id} className="hover:bg-gray-50">
                                ...
                                <td className="py-4 px-6">
                                    {product.imageUrl ? (
                                        ...
                                        <div className="h-16 w-16 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">No Image</div>
                                    )}
                                </td>
                                ...
                                <td className="py-4 px-6 text-sm text-gray-500">{product.price.toLocaleString()}đ</td>

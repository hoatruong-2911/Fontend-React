                ...
                <table className="min-w-full bg-white border">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            {/* 1. THÊM CỘT HÌNH ẢNH */}
                            <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Hình ảnh</th>
                            <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tên danh mục</th>
